...
/***/ (function(module, exports) {
	...
	var setLocationInformation = function setLocationInformation(info) {
	...
	var getLocationInfo = function getLocationInfo(locale) {
	  var url = "https://whether-to-weather.herokuapp.com/api/v1/location?location=" + locale;
	  fetch(url).then(function (response) {
	    return response.json();
	  }).then(function (info) {
	    return setLocationInformation(info);
	  }).catch(function (error) {
	    return console.error({ error: error });
	  });
	};
	...
	var setLocationBox = function setLocationBox(locale) {
	  $('.city').empty();
	...
	var setHourlyForecast = function setHourlyForecast(weather) {
	...
	var setWeeklyForecast = function setWeeklyForecast(weather) {
	...
	var getDayFormatted = function getDayFormatted(day) {
	...
	var getTimeFormatted = function getTimeFormatted(time) {
